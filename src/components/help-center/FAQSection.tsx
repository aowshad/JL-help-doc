...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "JewelsLab is a Shopify app that helps merchants offer customizable jewelry to customers with a simple and intuitive interface.",
  },
  {
            ...
            <div className="w-[768px] max-w-screen-md max-md:max-w-full">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  className={`min-w-80 ${
                    index > 0 ? "border-t border-[#D0D5DD] mt-8 pt-6" : ""
                  }`}
                >
                  <button
                    onClick={() =>
                    ...
                    className="flex w-full gap-6 flex-wrap max-md:max-w-full"
                  >
                    <div className="min-w-60 flex-1 shrink basis-[0%] max-md:max-w-full">
                      ...
                      {expandedIndex === index && faq.answer && (
                        <div className="text-[#475467] text-base font-normal leading-6 mt-2 max-md:max-w-full">
                          {faq.answer}
                        </div>
                      )}
                    </div>
                    <div className="w-6 pt-0.5">
                      <img
                        src={expandedIndex === index ? "https://cdn.builder.io/api/v1/image/assets/TEMP/2692d9a418436378cb4cec703e376677fa4415df?placeholderIfAbsent=true" : "https://cdn.builder.io/api/v1/image/assets/TEMP/9a07936382c59ddcf66c0a370dc7cc6d02e01c37?placeholderIfAbsent=true"}
