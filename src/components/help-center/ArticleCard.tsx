...
export const ArticleCard: React.FC<ArticleCardProps> = ({
  ...
  return (
    <div className="items-stretch border border-[color:var(--Grey,#C0C0C0)] self-stretch flex min-w-60 flex-col justify-center w-[368px] my-auto p-6 rounded-2xl border-solid max-md:px-5">
